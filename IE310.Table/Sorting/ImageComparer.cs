...
namespace IE310.Table.Sorting
{
	...
	/// </summary>
	public class I3ImageComparer : I3ComparerBase
	{
		#region Constructor
		...
		public I3ImageComparer(I3TableModel tableModel, int column, SortOrder sortOrder) : base(tableModel, column, sortOrder)
		{
