...
namespace IE310.Table.Design
{
	...
	/// one Type to another
	/// </summary>
	public class I3RowConverter : TypeConverter
	{
		/// <summary>
		...
		{
			if (destinationType == typeof(InstanceDescriptor) && value is I3Row)
			{
				ConstructorInfo ci = typeof(I3Row).GetConstructor(new Type[] {});
