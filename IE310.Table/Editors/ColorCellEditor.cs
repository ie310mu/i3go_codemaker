...
namespace IE310.Table.Editors
{
	...
	/// </summary>
	public class I3ColorCellEditor : I3DropDownCellEditor
	{
		...
		/// </summary>
		private I3ColorPicker colorpicker;
		...
		/// </summary>
		public I3ColorCellEditor() : base()
		{
			this.colorpicker = new I3ColorPicker(this);
		...
		protected override void SetEditLocation(Rectangle cellRect)
		{
			...
			int buttonWidth = ((I3ColorCellRenderer) renderer).ButtonWidth;
		...
		/// <summary>
        /// 将颜色转换为字符串，返回Web颜色、系统颜色的Name，或者ARGB值
        ...
        #region ColorPicker  颜色选择控件

        /// <summary>
        /// 颜色选择控件 包含自定义颜色、Web颜色、系统颜色
		/// A ColorPicker control similar to the ColorPicker found in the 
		/// VS.NET property window
		/// </summary>
		[ToolboxItem(false)]
		public class I3ColorPicker : Control
		{
			...
			/// 
			/// </summary>
			private I3ColorCellEditor editor;
			...
			/// 
			/// </summary>
			private I3ThemedTabPage customTabPage;

			/// <summary>
			/// 
			/// </summary>
			private I3ColorPalette palette;

			/// <summary>
			/// 
			/// </summary>
			private I3ThemedTabPage webTabPage;

			/// <summary>
			/// 
			/// </summary>
			private I3ColorListBox webListBox;

			/// <summary>
			/// 
			/// </summary>
			private I3ThemedTabPage systemTabPage;

			/// <summary>
			/// 
			/// </summary>
			private I3ColorListBox systemListBox;
			...
			/// </summary>
			public I3ColorPicker(I3ColorCellEditor editor)
			{
				if (editor == null)
				{
				...
				this.customTabPage = new I3ThemedTabPage();
				this.palette = new I3ColorPalette(editor);
				this.webTabPage = new I3ThemedTabPage();
				this.webListBox = new I3ColorListBox();
				this.systemTabPage = new I3ThemedTabPage();
				this.systemListBox = new I3ColorListBox();
				...
				Array.Sort(this.SystemColors, new I3ColorCellEditor.I3ColorPicker.I3SystemColorComparer());
            ...
            #region ColorPalette  自定义的颜色选择器

            /// <summary>
			/// 自定义的颜色选择器
			/// </summary>
			internal class I3ColorPalette : Control
			{
				#region Class Data
				...
				/// 构造函数
				/// </summary>
				public I3ColorPalette(I3ColorCellEditor editor) : base()
				{
					if (editor == null)
					{
						throw new ArgumentNullException("editor", "editor cannot be null");
				...
				private void InvalidateFocus()
				{
                    ...
                    //??????????
					I3NativeMethods.NotifyWinEvent(0x8005, base.Handle, -4, 1 + this.GetColorIndexFromCell(this.focus.X, this.focus.Y));
				}
				...
				protected virtual void LaunchDialog(int customIndex)
				{
					...
					I3frmColorPicker colorDialog = new I3frmColorPicker(this.GetColorFromCell(customIndex));
				...
				#region Custom Color ColorPicker  自定义颜色选择对话框
				...
				/// </summary>
				public class I3frmColorPicker : System.Windows.Forms.Form
				{
					#region Class Variables

					private I3AdobeColors.I3HSL		m_hsl;
					private Color				m_rgb;
					private I3AdobeColors.I3CMYK	m_cmyk;

					public enum I3eDrawStyle
					{
						Hue,
						Saturation,
						Brightness,
					...
					private I3ctrlVerticalColorSlider m_ctrl_ThinBox;
					private I3ctrl2DColorBox m_ctrl_BigBox;
					...
					public I3frmColorPicker(Color starting_color)
					{
						InitializeComponent();

						m_rgb = starting_color;
						m_hsl = I3AdobeColors.RGB_to_HSL(m_rgb);
						m_cmyk = I3AdobeColors.RGB_to_CMYK(m_rgb);
					...
					private void InitializeComponent()
					{
						...
						this.m_ctrl_ThinBox = new I3ctrlVerticalColorSlider();
						this.m_ctrl_BigBox = new I3ctrl2DColorBox();
						...
						// m_ctrl_ThinBox
						// 
						this.m_ctrl_ThinBox.DrawStyle = I3ctrlVerticalColorSlider.I3eDrawStyle.Hue;
						...
						// m_ctrl_BigBox
						// 
						this.m_ctrl_BigBox.DrawStyle = I3ctrl2DColorBox.I3eDrawStyle.Hue;
					...
					private void m_ctrl_BigBox_Scroll(object sender, System.EventArgs e)
					{
						...
						m_rgb = I3AdobeColors.HSL_to_RGB(m_hsl);
						m_cmyk = I3AdobeColors.RGB_to_CMYK(m_rgb);
					...
					private void m_rbtn_Hue_CheckedChanged(object sender, System.EventArgs e)
					{
						...
						{
							m_ctrl_ThinBox.DrawStyle = I3ctrlVerticalColorSlider.I3eDrawStyle.Hue;
							m_ctrl_BigBox.DrawStyle = I3ctrl2DColorBox.I3eDrawStyle.Hue;
						}
					}
					...
					private void m_rbtn_Sat_CheckedChanged(object sender, System.EventArgs e)
					{
						...
						{
							m_ctrl_ThinBox.DrawStyle = I3ctrlVerticalColorSlider.I3eDrawStyle.Saturation;
							m_ctrl_BigBox.DrawStyle = I3ctrl2DColorBox.I3eDrawStyle.Saturation;
						}
					}
					...
					private void m_rbtn_Black_CheckedChanged(object sender, System.EventArgs e)
					{
						...
						{
							m_ctrl_ThinBox.DrawStyle = I3ctrlVerticalColorSlider.I3eDrawStyle.Brightness;
							m_ctrl_BigBox.DrawStyle = I3ctrl2DColorBox.I3eDrawStyle.Brightness;
						}
					}
					...
					private void m_rbtn_Red_CheckedChanged(object sender, System.EventArgs e)
					{
						...
						{
							m_ctrl_ThinBox.DrawStyle = I3ctrlVerticalColorSlider.I3eDrawStyle.Red;
							m_ctrl_BigBox.DrawStyle = I3ctrl2DColorBox.I3eDrawStyle.Red;
						}
					}
					...
					private void m_rbtn_Green_CheckedChanged(object sender, System.EventArgs e)
					{
						...
						{
							m_ctrl_ThinBox.DrawStyle = I3ctrlVerticalColorSlider.I3eDrawStyle.Green;
							m_ctrl_BigBox.DrawStyle = I3ctrl2DColorBox.I3eDrawStyle.Green;
						}
					}
					...
					private void m_rbtn_Blue_CheckedChanged(object sender, System.EventArgs e)
					{
						...
						{
							m_ctrl_ThinBox.DrawStyle = I3ctrlVerticalColorSlider.I3eDrawStyle.Blue;
							m_ctrl_BigBox.DrawStyle = I3ctrl2DColorBox.I3eDrawStyle.Blue;
						}
					}
					...
					private void m_txt_Cyan_Leave(object sender, System.EventArgs e)
					{
						...
						m_rgb = I3AdobeColors.CMYK_to_RGB(m_cmyk);
						m_hsl = I3AdobeColors.RGB_to_HSL(m_rgb);
						m_ctrl_BigBox.HSL = m_hsl;
						m_ctrl_ThinBox.HSL = m_hsl;
						m_lbl_Primary_Color.BackColor = m_rgb;
					...
					public I3eDrawStyle DrawStyle
					{
						get
						{
							if ( m_rbtn_Hue.Checked )
								return I3eDrawStyle.Hue;
							else if ( m_rbtn_Sat.Checked )
								return I3eDrawStyle.Saturation;
							else if ( m_rbtn_Black.Checked )
								return I3eDrawStyle.Brightness;
							else if ( m_rbtn_Red.Checked )
								return I3eDrawStyle.Red;
							else if ( m_rbtn_Green.Checked )
								return I3eDrawStyle.Green;
							else if ( m_rbtn_Blue.Checked )
								return I3eDrawStyle.Blue;
							else
								return I3eDrawStyle.Hue;
						}
						set
						{
							switch(value)
							{
								case I3eDrawStyle.Hue :
									m_rbtn_Hue.Checked = true;
									break;
								case I3eDrawStyle.Saturation :
									m_rbtn_Sat.Checked = true;
									break;
								case I3eDrawStyle.Brightness :
									m_rbtn_Black.Checked = true;
									break;
								case I3eDrawStyle.Red :
									m_rbtn_Red.Checked = true;
									break;
								case I3eDrawStyle.Green :
									m_rbtn_Green.Checked = true;
									break;
								case I3eDrawStyle.Blue :
				...
				/// </summary>
				[ToolboxItem(false)]
				public class I3ctrl2DColorBox : System.Windows.Forms.UserControl
				{
					#region Class Variables
					...
					private I3eDrawStyle		m_eDrawStyle = I3eDrawStyle.Hue;
					private I3AdobeColors.I3HSL	m_hsl;
					private Color			m_rgb;
					...
					public I3ctrl2DColorBox()
					{
						// This call is required by the Windows.Forms Form Designer.
						InitializeComponent();

						//	Initialize Colors
						m_hsl = new I3AdobeColors.I3HSL();
						m_hsl.H = 1.0;
						m_hsl.S = 1.0;
						m_hsl.L = 1.0;
						m_rgb = I3AdobeColors.HSL_to_RGB(m_hsl);
						m_eDrawStyle = I3eDrawStyle.Hue;
					}
					...
					/// </summary>
					public I3AdobeColors.I3HSL HSL
					{
						get
						{
							return m_hsl;
					...
					private void ClearMarker()
					{
						...
						I3AdobeColors.I3HSL hsl_start = new I3AdobeColors.I3HSL();
						I3AdobeColors.I3HSL hsl_end = new I3AdobeColors.I3HSL();
						...
						switch (m_eDrawStyle)
						{
							...
							case I3eDrawStyle.Hue :	
								...
								for ( int i = start_y; i <= end_y; i++ )		//	For each horizontal line:
								{
									...
									LinearGradientBrush br = new LinearGradientBrush(new Rectangle(start_x + 1,i + 2, end_x - start_x + 1, 1), I3AdobeColors.HSL_to_RGB(hsl_start), I3AdobeColors.HSL_to_RGB(hsl_end), 0, false); 
							...
							case I3eDrawStyle.Saturation :
								...
								for ( int i = start_x; i <= end_x; i++ )				//	For each vertical line:
								{
									...
									LinearGradientBrush br = new LinearGradientBrush(new Rectangle(i + 2,start_y + 1, 1, end_y - start_y + 2), I3AdobeColors.HSL_to_RGB(hsl_start), I3AdobeColors.HSL_to_RGB(hsl_end), 90, false); 
					...
					{																	//	  *  |  *
						...
						Pen pen;
						I3AdobeColors.I3HSL _hsl = GetColor(x,y);	//	The selected color determines the color of the marker drawn over
						//	it (black or white)
					...
					private void Draw_Style_Hue()
					{
						...
						for ( int i = 0; i < this.Height - 4; i++ )				//	For each horizontal line in the control:
						{
							...
							LinearGradientBrush br = new LinearGradientBrush(new Rectangle(2,2, this.Width - 4, 1), I3AdobeColors.HSL_to_RGB(hsl_start), I3AdobeColors.HSL_to_RGB(hsl_end), 0, false); 
					...
					private void Draw_Style_Saturation()
					{
						...
						for ( int i = 0; i < this.Width - 4; i++ )		//	For each vertical line in the control:
						{
							...
							LinearGradientBrush br = new LinearGradientBrush(new Rectangle(2,2, 1, this.Height - 4), I3AdobeColors.HSL_to_RGB(hsl_start), I3AdobeColors.HSL_to_RGB(hsl_end), 90, false); 
					...
					/// <param name="y"></param>
					/// <returns></returns>
					private I3AdobeColors.I3HSL GetColor(int x, int y)
					{

						I3AdobeColors.I3HSL _hsl = new I3AdobeColors.I3HSL();
						...
						switch (m_eDrawStyle)
						{
							...
							case I3eDrawStyle.Brightness :
								...
								break;
							case I3eDrawStyle.Red :
								_hsl = I3AdobeColors.RGB_to_HSL(Color.FromArgb(m_rgb.R, Round(255 * (1.0 - (double)y/(this.Height - 4))), Round(255 * (double)x/(this.Width - 4))));
								break;
							case I3eDrawStyle.Green :
								_hsl = I3AdobeColors.RGB_to_HSL(Color.FromArgb(Round(255 * (1.0 - (double)y/(this.Height - 4))), m_rgb.G, Round(255 * (double)x/(this.Width - 4))));
								break;
							case I3eDrawStyle.Blue :
								_hsl = I3AdobeColors.RGB_to_HSL(Color.FromArgb(Round(255 * (double)x/(this.Width - 4)), Round(255 * (1.0 - (double)y/(this.Height - 4))), m_rgb.B));
								break;
						}
				...
				/// </summary>
				[ToolboxItem(false)]
				public class I3ctrlVerticalColorSlider : System.Windows.Forms.UserControl
				{
					#region Class Variables
					...
					public I3ctrlVerticalColorSlider()
					{
						// This call is required by the Windows.Forms Form Designer.
						InitializeComponent();
					...
					private void Draw_Style_Hue()
					{
						...
						for ( int i = 0; i < this.Height - 8; i++ )	//	i represents the current line of pixels we want to draw horizontally
						{
							...
							Pen pen = new Pen(I3AdobeColors.HSL_to_RGB(_hsl));	//	Get the Color for this line
				...
				/// </summary>
				public class I3AdobeColors
				{
					#region Constructors / Destructors

					public I3AdobeColors() 
					{ 
					} 
					...
					public static Color HSL_to_RGB(I3HSL hsl) 
					{ 
						int Max, Mid, Min;
						double q;
					...
					public static I3HSL RGB_to_HSL (Color c) 
					{ 
						I3HSL hsl =  new I3HSL(); 
					...
					public static I3CMYK RGB_to_CMYK(Color c)
					{
						I3CMYK _cmyk = new I3CMYK();
						double low = 1.0;
					...
					public static Color CMYK_to_RGB(I3CMYK _cmyk)
					{
						int red, green, blue;
            ...
            #region ColorListBox  颜色列表框

            /// <summary>
			/// 颜色列表框
			/// </summary>
			internal class I3ColorListBox : ListBox
			{
				/// <summary>
				/// 
				/// </summary>
				public I3ColorListBox() : base()
				{
            ...
            #region ThemedTabPage  带皮肤的TabPage

            /// <summary>
			/// 带皮肤的TabPage
			/// </summary>
			internal class I3ThemedTabPage : TabPage
			{
				/// <summary>
				/// 
				/// </summary>
                ...
                protected override void OnPaintBackground(PaintEventArgs e)
                {
                    if (I3ThemeManager.VisualStylesEnabled)
                    {
                        ...
                        {
                            I3ThemeManager.DrawTabPageBody(e.Graphics, new Rectangle(0, 0, this.Width, this.Height));
                        }
                    }
                    else
                    {
				...
				private bool PaintChildrenBackground(Graphics g, Control control, Rectangle rect, int ofx, int ofy)
				{
                    foreach (Control child in control.Controls)
                    {
                        ...
                        if (find.Contains(rect))
                        {
                            ...
                            I3ThemeManager.DrawTabPageBody(g, new Rectangle(-ofx, -ofy, this.Width, this.Height), new Rectangle(child.Left, child.Top, child.Width, child.Height));
            ...
            #region WebColorComparer  Web颜色 比较器

            /// <summary>
			/// Web颜色 比较器
			/// </summary>
			private class I3WebColorComparer : IComparer
			{
				/// <summary>
				/// 
				/// </summary>
            ...
            #region SystemColorComparer  系统颜色 比较器

            /// <summary>
			/// 系统颜色 比较器
			/// </summary>
			private class I3SystemColorComparer : IComparer
			{
				/// <summary>
				/// 
				/// </summary>
