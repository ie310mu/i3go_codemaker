...
namespace IE310.Table.Cell
{
	...
	TypeConverter(typeof(I3CellPaddingConverter))]
	public struct I3CellPadding 
	{
		#region Class Data
		...
		/// left uninitialized
		/// </summary>
		public static readonly I3CellPadding Empty = new I3CellPadding(0, 0, 0, 0);
		...
		public I3CellPadding(int left, int top, int right, int bottom)
		{
			this.left = left;
			this.right = right;
			this.top = top;
		...
		/// <summary>
        /// 获取对象是否为空，为空时返回true
        /// 注：left rigth top bottom都=0时，为空
		...
		public static bool operator ==(I3CellPadding left, I3CellPadding right)
		{
	...
	/// one Type to another
	/// </summary>
	internal class I3CellPaddingConverter : TypeConverter
	{
		/// <summary>
		...
		public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
		{
			if (value is string)
			{
				...
				return new I3CellPadding(int.Parse(s[0]), int.Parse(s[1]), int.Parse(s[2]), int.Parse(s[3]));
			}	
		...
		{
			return new I3CellPadding((int) propertyValues["Left"], 
		...
		{
			PropertyDescriptorCollection collection = TypeDescriptor.GetProperties(typeof(I3CellPadding), attributes);
