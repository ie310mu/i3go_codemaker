...
{
    public class I3PopupControlHost : ToolStripDropDown
    {
        #region Fields
        ...
        public I3PopupControlHost(Control control)
        {
            DoubleBuffered = true;
            ResizeRedraw = true;
            AutoSize = false;
        ...
        private void SetOwnerItem(Control control)
        {
            ...
            if (control is I3PopupControlHost)
            {
                I3PopupControlHost popupControl = control as I3PopupControlHost;
        ...
        private bool ProcessGrip(ref Message m)
        {
            if (_canResize && !_changeRegion)
            {
                switch (m.Msg)
                {
                    case I3NativeMethods.WM_NCHITTEST:
                        return OnNcHitTest(ref m);
                    case I3NativeMethods.WM_GETMINMAXINFO:
        ...
        private bool OnGetMinMaxInfo(ref Message m)
        {
            ...
            {
                I3NativeMethods.MINMAXINFO minmax =
                    (I3NativeMethods.MINMAXINFO)Marshal.PtrToStructure(
                    m.LParam, typeof(I3NativeMethods.MINMAXINFO));
