...
{
    public static class SpellCodeUtil  
    {  
    ...
    "Zhuang","Zhui","Zhun","Zhuo","Zi","Zong","Zou","Zu","Zuan","Zui","Zun","Zuo"  
        ...
        /// <summary>
        /// 从字符串中获取汉字拼音首字母，不是汉字则原样输出    如果有异常原样返回
        /// </summary>
        /// <param name="transName"></param>
        /// <returns></returns>
        public static string GetFirstPYLetter2(string transName)
        {
            try
            {
                return GetFirstPYLetter(transName);
            }
            catch
            {
                return transName;
        ...
        /// <summary>
        /// 把汉字转换成拼音(全拼)    如果有异常原样返回
        /// </summary>
        /// <param name="transName"></param>
        /// <returns></returns>
        public static string GetAllPYLetters2(string transName)
        {
            try
            {
                return GetAllPYLetters(transName);
            }
            catch
            {
                return transName;
